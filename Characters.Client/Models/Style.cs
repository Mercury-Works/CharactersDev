...
using MercuryWorks.Characters.Shared.Models.Style;
using NFive.SDK.Core.Helpers;
using NFive.SDK.Core.Models;
using System;
using Prop = MercuryWorks.Characters.Shared.Models.Style.Prop;
...
namespace MercuryWorks.Characters.Client.Models
{
	public class Style : IdentityModel, IStyle
	{
		...
		public static Style ConvertStyle(CitizenFX.Core.Style style, Guid? id = null) => new Style
		{
